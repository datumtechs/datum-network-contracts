...
contract('ERC20Factory', (accounts) => {
  ...
  beforeEach(async () => {
    tokenTemplate = await ERC20Template.new();
    factory = await ERC20Factory.new(tokenTemplate.address);
    ...
    token = await ERC20Template.at(tokenCreatedLog.args.newTokenAddress);
  })
